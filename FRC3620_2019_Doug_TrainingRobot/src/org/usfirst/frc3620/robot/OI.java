...
public class OI {
    ...
    // ********************************* ok to add here!!!!
    public JoystickButton joystickButtonA, joystickButtonB, joystickButtonX;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        joystickButtonX = new JoystickButton(joystick0, XBoxConstants.BUTTON_X);
        joystickButtonX.toggleWhenPressed(new ButtonXCommand());
