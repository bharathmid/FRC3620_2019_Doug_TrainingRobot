...
public class RobotMap {
    ...
    public static void init() {
        ...
        resetControllerToKnownState(driveSubsystemLeftSpeedController);
        ...
        resetControllerToKnownState(driveSubsystemRightSpeedController);
    ...
    static void resetControllerToKnownState (BaseMotorController x) {
		...
		x.configPeakOutputForward(5.0/6.0, 0);
		x.configPeakOutputReverse(-5.0/6.0, 0);
